...
LotVmod_stock <- function (Time, State, Pars) {
    with(as.list(c(State, Pars)), {
        ...
        dx2 = x1*alpha2*(1-x1/K2) - (beta2*y*x2)*r2
        dy = delta1*x1*y + delta2*x2*y - gamma*y
        return(list(c(dx1,dx2 ,dy)))
    })
}
...
out.m <- model_system(LotVmod_stock, c(alpha1 = 0.1, beta1 = 0.02, gamma = 0.4, delta1 = 0.02, K1 = 100, tau1 = 0.3,alpha2 = 0.1, beta2 = 0.02, K2 = 100, tau2 = 0.3, delta2 = 0.02, sigma1 = 0.01, sigma2 = 0.01, m12 = 1), 
                      c(x1 = 30,x2 = 10 ,y = 10), TRUE)
out <- model_system(LotVmod_stock, c(alpha1 = 0.1, beta1 = 0.02, gamma = 0.4, delta1 = 0.02, K1 = 100, tau1 = 0.3,alpha2 = 0.1, beta2 = 0.02, K2 = 100, tau2 = 0.3, delta2 = 0.02, sigma1 = 0.01, sigma2 = 0.01, m12 = 1), 
                      c(x1 = 30,x2 = 10 ,y = 10), FALSE)
